...
import { CheckCircle, XCircle, Clock, Trophy, WorkflowIcon } from 'lucide-react'
...
export default function GradesBreakdown({ username, isExpanded, onOpenActions }: GradesBreakdownProps) {
